...
Action codes are very helpful because they allow us to differentiate between the various actions of the same general type. 
Some questions to answer about the action codes:
...
4.  For actions without a code, can we infer a description for the action similar to action codes?
5.  Do we have duplicate actions?
...
For actions without a code, can we can we infer a description for the action similar to action codes?
Below I count the instances of `action_text` to see which occur most often. 
