...
```{r}
(house_bill_actions = map(house_bills, select, billType, billNumber, title, introducedDate, actions, action_counts) %>% 
  map_dfr(unnest, actions) %>% 
  arrange(billType, billNumber, actionDate, actionTime) %>% 
  select(billType, billNumber, title, introducedDate, action_counts, 
         actionDate, actionTime, action_type, action_text, action_sourceSystem_name, actionCode, action_committee_name) %>% 
