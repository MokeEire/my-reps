...
Let's start with the bill type that has the fewest bills to see how long it takes to parse

```{r}
tic()
(hjres_bills = house_bill_files$hjres %>% 
...
```{r}
tic()
(hres_bills = house_bill_files$hres %>% 
  future_map_dfr(extract_bill_status))
toc()
```
